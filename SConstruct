...
# TODO: find and submit pull request to appropriate repo 
# by default for nativescript1.1 branch the compilation target is not debug
opts.Add(EnumVariable('platform', "Compilation platform", '', ['', 'windows', 'x11', 'linux', 'osx']))
opts.Add(EnumVariable('p', "Compilation target, alias for 'platform'", '', ['', 'windows', 'x11', 'linux', 'osx']))
opts.Add(BoolVariable('use_llvm', "Use the LLVM / Clang compiler", 'no'))
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'blockit/bin/'))
opts.Add(PathVariable('target_name', 'The library name.', 'lib_blockit', PathVariable.PathAccept))
